...
export const getCountryConfig = (countryCode) =>
  SUPPORTED_COUNTRIES.find((country) => country.code === String(countryCode || DEFAULT_COUNTRY_CODE).toUpperCase())
...
export const isValidPhoneForCountry = (value, countryCode) =>
  normalizeNationalNumber(value, countryCode).length === getCountryConfig(countryCode).phoneDigits;
